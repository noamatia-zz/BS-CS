...
main(int argc, char **argv)
{
  ...
  16:	80658593          	addi	a1,a1,-2042 # 818 <malloc+0xe8>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	628080e7          	jalr	1576(ra) # 644 <fprintf>
    exit(1);
  24:	4505                	li	a0,1
  ...
  36:	1b4080e7          	jalr	436(ra) # 1e6 <atoi>
  3a:	892a                	mv	s2,a0
  3c:	6888                	ld	a0,16(s1)
  3e:	00000097          	auipc	ra,0x0
  42:	1a8080e7          	jalr	424(ra) # 1e6 <atoi>
  46:	85aa                	mv	a1,a0
  48:	854a                	mv	a0,s2
  4a:	00000097          	auipc	ra,0x0
  4e:	338080e7          	jalr	824(ra) # 382 <trace>
  52:	00054763          	bltz	a0,60 <main+0x60>
    fprintf(2, "trace: failed to trace\n");
  exit(0);
  56:	4501                	li	a0,0
  58:	00000097          	auipc	ra,0x0
  5c:	28a080e7          	jalr	650(ra) # 2e2 <exit>
    fprintf(2, "trace: failed to trace\n");
  60:	00000597          	auipc	a1,0x0
  64:	7d858593          	addi	a1,a1,2008 # 838 <malloc+0x108>
  68:	4509                	li	a0,2
  6a:	00000097          	auipc	ra,0x0
  6e:	5da080e7          	jalr	1498(ra) # 644 <fprintf>
  72:	b7d5                	j	56 <main+0x56>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	47a50513          	addi	a0,a0,1146 # 858 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ae:	3aeb8b93          	addi	s7,s7,942 # 858 <digits>
 ...
 5ee:	26690913          	addi	s2,s2,614 # 850 <malloc+0x120>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b6:	1be7b783          	ld	a5,446(a5) # 870 <freep>
 ...
 6e4:	00e6ea63          	bltu	a3,a4,6f8 <free+0x50>
{
 ...
 726:	14f73723          	sd	a5,334(a4) # 870 <freep>
}
 72a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 758:	11c53503          	ld	a0,284(a0) # 870 <freep>
 ...
 780:	0f490913          	addi	s2,s2,244 # 870 <freep>
  if(p == (char*)-1)
 784:	5afd                	li	s5,-1
 786:	a895                	j	7fa <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 788:	00000797          	auipc	a5,0x0
 78c:	0f078793          	addi	a5,a5,240 # 878 <base>
 790:	00000717          	auipc	a4,0x0
 794:	0ef73023          	sd	a5,224(a4) # 870 <freep>
 798:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7bc:	0aa73c23          	sd	a0,184(a4) # 870 <freep>
      return (void*)(p + 1);
 ...
 80a:	b64080e7          	jalr	-1180(ra) # 36a <sbrk>
  if(p == (char*)-1)
